...
public class AllCourseDB extends SQLiteOpenHelper {	   
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.insert("AllCourses", null, addcourse("50","컴퓨터프로그래밍","12","류기열","팔309","3","RM","tueA friA"));
        db.insert("AllCourses", null, addcourse("57","운영체제","22","김재훈","팔110","3","RM","monA wedA"));
        db.insert("AllCourses", null, addcourse("14","수학1","12","김성재","성204","3","RL","tueA friA"));
        db.insert("AllCourses", null, addcourse("15","수학2","21","김수진","성203","3","RL","tueD friD"));
        db.insert("AllCourses", null, addcourse("70","데이터베이스","31","변광준","팔110","4","RM","tueB thuA"));
        db.insert("AllCourses", null, addcourse("72","컴퓨터공학개론","11","류기열","팔1025","3","RM","monB thuB"));
        db.insert("AllCourses", null, addcourse("73","네트워크운용사례","32","조영종","팔328","3","EM","tueA tueB"));
        db.insert("AllCourses", null, addcourse("74","모바일서비스플랫폼","41","정태선","팔309","3","EM","tueB thuA"));
        db.insert("AllCourses", null, addcourse("78","정보보호","31","손태식","팔309","3","RM","monE wedE"));
        ...
        db.insert("AllCourses", null, addcourse("21","물리학1","11","정역학","성205","3","RL","tueA friA"));
        db.insert("AllCourses", null, addcourse("29","생명과학실험","12","김민수","실104","1","RL","tueC tueD"));
        db.insert("AllCourses", null, addcourse("52","디지털회로","21","김성수","팔309","3","RM","monB thuB"));
        db.insert("AllCourses", null, addcourse("56","자료구조","12","강경란","팔410","3","RM","tueA thuA"));
        db.insert("AllCourses", null, addcourse("59","알고리즘","32","손경아","팔110","3","RM","monD thuD"));
        ...
        db.insert("AllCourses", null, addcourse("9","영어2","11","Theresia","율405","3","EL","monA wedA"));
        db.insert("AllCourses", null, addcourse("83","데이터마이닝","42","정태선","팔328","3","EM","wedF friF"));
        db.insert("AllCourses", null, addcourse("97","네트워크소프트웨어실습","31","정태선","팔325","1","RM","friE friF"));
        db.insert("AllCourses", null, addcourse("98","무선네트워크","32","조영종","팔328","3","RM","monC thuC"));
        db.insert("AllCourses", null, addcourse("79","컴파일러","31","김재훈","팔1025","3","RM","tueA friA"));
        ...
        db.insert("AllCourses", null, addcourse("62","종합설계프로젝트","42","김재훈","종104","4","RM","tueC 2F"));        
    }
